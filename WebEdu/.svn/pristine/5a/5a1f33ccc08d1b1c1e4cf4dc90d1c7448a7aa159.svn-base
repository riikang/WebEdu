...
<html lang="en">
    ...
    <body>
        ...
        <div id="loginbox">            
            <form id="loginform" class="form-vertical" action="<%=path %>/student/managerAction_loginCheck.action" />
				<p>请输入用户名和密码</p>
                <div class="control-group">
                    <div class="controls">
                        <div class="input-prepend">
                            <span class="add-on"><i class="icon-user"></i></span><input type="text" name="manager.username" placeholder="用户名" style="height:30px;" />
                        </div>
                    </div>
                </div>
                <div class="control-group">
                    <div class="controls">
                        <div class="input-prepend">
                            <span class="add-on"><i class="icon-lock"></i></span><input type="password" name="manager.password" placeholder="密码" style="height:30px;" />
                        </div>
                    </div>
                </div>
