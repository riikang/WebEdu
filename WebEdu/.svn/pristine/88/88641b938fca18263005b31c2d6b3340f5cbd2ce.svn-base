		...
		<div id="sidebar">
			...
			<ul>
				...
				<li class="submenu active open">
					...
					<ul>
						<li><a href="<%=path %>/teacher/teacher-addCourse.jsp">添加课程</a></li>
						<li><a href="<%=path %>/student/teacherAction_addAllResources.action">添加资源</a></li>
						<li class="active"><a href="<%=path %>/teacher/teacher-resetPassword.jsp">修改密码</a></li>
					</ul>
				</li>
				<li><a href="<%=path %>/teacher/teacher-tables.jsp"><i class="icon icon-th"></i> <span>表格</span></a></li>
				<li>
