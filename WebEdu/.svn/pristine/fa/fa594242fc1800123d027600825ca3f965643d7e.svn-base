	...
	<body>
		...
		<div id="user-nav" class="navbar navbar-inverse">
            <ul class="nav btn-group">
                ...
                <li class="btn btn-inverse"><a title="" href="<%=path %>/manager/teacher-login.jsp"><i class="icon icon-share-alt"></i> <span class="text">注销</span></a></li>
            </ul>
        </div>
				...
				<div class="row-fluid">
					<div class="span12">
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								<form action="<%=path %>/student/addResourceAction.action" method="post" class="form-horizontal" enctype="multipart/form-data"/>
									<div class="control-group">
										<label class="control-label">资源所属课程</label>
										<div class="controls">
											<select name="course.cid" id="cid" style="width:150px;">
											<s:iterator value="courses" id="list">
												<option value="<s:property value="#list.cid"/>"><s:property value="#list.cname"/></option>
												</s:iterator>
											</select>
										</div>
									</div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="resource.resource_name" id="resource_name" style="height:30px;" />
                                        </div>
                                    </div>                             
									<div class="control-group">
