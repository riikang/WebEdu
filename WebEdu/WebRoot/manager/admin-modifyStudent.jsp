			...
			<ul>
				...
				<li class="submenu active open">
					...
					<ul>
						...
						<li class="active"><a href="<%=path %>/student/managerAction_findAllStudents.action"> <span>学生管理</span></a></li>
					</ul>
				</li>
				<li>
					...
					<div class="span12">
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								<form class="form-horizontal" method="post" action="<%=path %>/student/managerAction_modifyStudent.action?student.sid=<s:property value="student.sid"/>" name="basic_validate" id="basic_validate" novalidate enctype="multipart/form-data">
								<s:hidden name="student.sid" value="%{student.sid}"></s:hidden>
								<s:hidden name="student.username" value="%{student.username}"></s:hidden>
								<s:hidden name="student.password" value="%{student.password}"></s:hidden>
                                    <div class="control-group">
                                        <label class="control-label">学生姓名</label>
                                        <div class="controls" >
                                            <input type="text" name="student.sname" value="<s:property value="student.sname"/>" id="student_name" style="height: 30px;"/>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
											...
											<s:hidden id="ssex" name="student.sex1" value="%{student.sex}"/>
											<script>
													document.getElementById("sex").value=document.getElementById("ssex").value;
											</script>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="date" name="student.birthday" value="${student.birthday }" id="birthday" style="height: 30px;" />
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">联系地址</label>
                                        <div class="controls">
                                            <input type="text" name="student.address" value="<s:property value="student.address"/>" id="address" style="height: 30px;" />
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">联系电话</label>
                                        <div class="controls">
                                            <input type="text" name="student.phoneNum" value="<s:property value="student.phoneNum"/>" id="phoneNum" style="height: 30px;" />
                                        </div>
                                    </div>
