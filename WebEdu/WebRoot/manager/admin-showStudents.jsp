...
<html lang="en">
	<head>
		<title>tables</title>
		<s:iterator value="students" id="slist">
		<script type="text/javascript">
	function clickme(){
	  if(confirm("确认删除？")==true){
	  
		window.location.href="<%=path %>/student/managerAction_deleteStudent.action?student.sid=<s:property value="#slist.sid"/>";
		
	  }else{
	  	window.location.href="<%=path %>/student/managerAction_findAllStudents.action";
	  }
	}
	</script>
	</s:iterator>
	...
	<body>
		...
		<div id="sidebar">
			<a href="#" class="visible-phone"><i class="icon icon-th-list"></i> 学生管理</a>
			<ul>
						...
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								<table class="table table-bordered data-table">
									...
									<tbody>
									<s:iterator value="students" id="stulist">
									<!--<s:hidden name="stulist.sid" value="#stulist.sid"></s:hidden>
                                    <s:hidden name="stulist.username" value="#stulist.username"></s:hidden>
                                    <s:hidden name="stulist.password" value="#stulist.password"></s:hidden>-->
									<tr class="gradeX">
									<td><s:property value="#stulist.username"/></td>
									<td><s:property value="#stulist.sname"/></td>
									<td><s:property value="#stulist.sex"/></td>
									<td class="center"><s:property value="#stulist.address"/></td>
									<td><s:property value="#stulist.birthday"/></td>
									<td><s:property value="#stulist.phoneNum"/></td>
                                    <td>
                                    
                                      <center><a href="<%=path %>/student/managerAction_findStudentById.action?student.sid=<s:property value="#stulist.sid"/>" class="tip-top" data-original-title="Update"><img src="../img/Modify.png"></a>
