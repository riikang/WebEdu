	...
	var filterList = {
		init:function(){
			...
			$('#portfoliolist').mixitup({
				...
				effects: ['fade'],
				easing: 'snap',
				onMixEnd: filterList.hoverEffect()//调用过滤动画
			});				
		},
...
<div class="content" style="min-height:1000px;">
	...
	<div id="portfoliolist">
		<s:iterator value="tcs" id="tc">
			<div class="portfolio <s:property value="#tc.course_id.type"/>" data-cat="<s:property value="#tc.course_id.type"/>" 
				onclick="window.location.href='<%=path%>/student/courseAction_findTheCourse.action?id=<s:property value="#tc.course_id.cid"/>'" >
			<div class="portfolio-wrapper">
				<img src="<s:property value="#tc.course_id.cimg"/>" width="264" height="198" alt="" />
				<div class="label">
					<div class="label-text">
						<a class="text-title"><s:property value="#tc.course_id.cname"/></a>
						<span class="text-category"><s:property value="#tc.course_id.type"/></span>
					</div>
